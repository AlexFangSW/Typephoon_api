...
class TokenGenerator:
    ...
    def gen_access_token(
        self, user_id: str, username: str, user_type: UserType = UserType.REGISTERED
    ) -> str:
        ...
        return jwt.encode(
            payload.model_dump(), self._setting.token.private_key, algorithm="RS256"
        )
    ...
    def gen_token_pair(
        ...
        return GenTokenPairRet(access_token=access_token, refresh_token=refresh_token)
